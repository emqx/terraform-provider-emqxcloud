...
~> **Upgrade note:** v0.1 configurations must remove `rule_id` and `config_json.name`; the existing state identity
remains unchanged.
...
- `rule_id` (String) Provider-generated EMQX rule identifier.
